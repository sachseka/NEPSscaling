...
mod <- TAM::tam.mml.mfr(resp[, items],
                        irtmodel = "1PL", dataY = bgdata, formulaY = frmY,
                        facets = position, formulaA = ~ 0 + item + position,
...
test_that("estimate_cross_rasch_corrected_for_rotation", {
  test <- estimate_cross_rasch_corrected_for_rotation(bgdata, imp,
                                                      frmY, resp,
                                                      position, waves,
                                                      ID_t, type, domain,
                                                      SC, control, npv)
