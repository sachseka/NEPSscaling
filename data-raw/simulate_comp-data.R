...
beta <- rnorm(30)
rasch_prob <- function(theta, beta) {return(1/(1+exp(-(theta-beta))))}
...
colnames(xTargetCompetencies_sim) <- c('rea30110_c', 'rea3012s_c', 'rea30130_c', 'rea30140_c', 'rea3015s_c', 'rea30210_c'
