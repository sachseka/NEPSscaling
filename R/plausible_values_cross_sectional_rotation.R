# estimation of cross-sectional plausible values (test rotation)

cross_sectional_rotation <- function(bgdata, imp, frmY = NULL, resp, position,
                                     waves, ID_t, type, domain, SC,
                                     control, npv) {
  pvs <- list(NULL)
  EAP.rel <- NULL
  eap <-
