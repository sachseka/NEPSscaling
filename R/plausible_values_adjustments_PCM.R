## Adjustments to Partial Credit items (i.e. collapsing of
## sparsely populated cells) according to NEPS scaling
## guidelines as laid out in Pohl & Carstensen (2012)

adjustments_PCM <- function(resp, SC, wave, domain) {
  if (SC == "SC6") {
    if (domain == "RE") {
