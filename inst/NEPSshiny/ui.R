      ...
      tags$head(
        tags$style(
          HTML(".shiny-notification {
             ...
             #input_pv_obj {background-color:#24195D;}
             #input_bgdata {background-color:#24195D;}
             #scale_level {background-color:#24195D;}
             "
          )
        )
      ),
        ...
        sidebarPanel(
          ...
          conditionalPanel(
            ...
            shinyWidgets::dropdownButton(
              ...
              fileInput(inputId = "import_state", label = tags$strong("Import pv_obj"),
              ...
              width = "300px", label = h4("Manage pv_obj")#,
            ...
            shinyWidgets::dropdownButton(
              ...
              actionButton(inputId = "Display_Bgdata", label=  "Inspect background data"), 
              hidden(
              ...
              circle = FALSE, status = "primary",
              width = "300px", label = h4("Manage background data")#,
            ...
            shinyWidgets::dropdownButton(
              inputId = "scale_level",
              checkboxInput(inputId = "metric", label = tags$strong("All variables are metric."),
                            value = FALSE),
              ...
              circle = FALSE, status = "primary",
              width = "300px", label = h4("Set scale levels of background data")#,
